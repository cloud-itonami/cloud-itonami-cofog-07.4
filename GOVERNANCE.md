...
`cloud-itonami-cofog-07.4` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
- the advisor cannot directly dispatch a robot action or commit a public
  record.
- the Public Health Governor remains independent of the advisor.
...
licensing the operator's jurisdiction requires for community vector-control and environmental health work.
